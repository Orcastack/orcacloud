...
const ProtectedRoute: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  if (!user) {
    if (portalVariant === 'cloud' || portalVariant === 'developer' || portalVariant === 'matrix' || portalVariant === 'enterprise' || portalVariant === 'mail' || portalVariant === 'devops') {
      const loginTarget = portalVariant === 'developer' || portalVariant === 'devops' ? 'developer' : portalVariant === 'matrix' || portalVariant === 'enterprise' ? 'matrix' : 'cloud';
      window.location.assign(getPortalLoginUrl(loginTarget));
      return null;
    }
...
const AppShell: React.FC = () => {
  ...
  if (portalVariant === 'mail' && location.pathname === '/') {
