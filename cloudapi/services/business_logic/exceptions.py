...
All business logic exceptions inherit from OrcaCloudException for consistent
...
class OrcaCloudException(Exception):
...
class InstanceError(OrcaCloudException):
...
class KubernetesError(OrcaCloudException):
...
class ServerlessFunctionError(OrcaCloudException):
...
class AutoScalingError(OrcaCloudException):
...
class StorageError(OrcaCloudException):
...
class NetworkingError(OrcaCloudException):
